...
This repository contains coursework, assignments, and experiments completed as part of a **Pattern Recognition** course.
...
- Each `Assignment_XX_*` folder corresponds to a specific coursework assignment.
